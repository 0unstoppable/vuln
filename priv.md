...
The student can view his data such as marks, attendance. So susdent A can access only his data. If somehow a student B manage to access the data of student A then it is known as Horizontal privilege escalation.
...
For example if mysql is running as root then use 
	Commend :- select sys_exec(‘any linux commands’);
